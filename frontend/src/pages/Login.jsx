  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-gray-800 text-center mb-2">AI销冠助手</h1>
        <p className="text-sm text-gray-400 text-center mb-8">教培销售智能分析系统</p>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          还没账号？
          <Link to="/register" className="text-blue-600 ml-1 hover:underline">去注册</Link>
        </p>
      </div>
    </div>
  )
