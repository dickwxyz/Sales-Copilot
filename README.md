...
聚焦 0-10 岁亲子游泳赛道，AI 辅助销售分析客户聊天记录，智能识别客户心理阶段、生成客户画像、提供推进话术建议，帮助教培销售提高成单率。
...
本项目源于教培行业销售管理的实际需求。传统销售培训依赖师徒带教和经验积累，新人上手慢、优秀销售经验难以复制。AI 销冠助手通过分析销售与客户的真实聊天记录，利用大语言模型自动识别客户心理阶段、提取关键信息、生成个性化话术，将销冠的成交经验数据化、可复制，帮助每个销售提升成交能力。

初期聚焦 0-10 岁亲子游泳赛道，后续可快速扩展到其他教培品类。
